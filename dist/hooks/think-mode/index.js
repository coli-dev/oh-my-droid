...
import { getHighVariant, isAlreadyHighVariant, getThinkingConfig, getDroidThinkingConfig } from './switcher.js';
...
/**
 * Create the think mode hook for Droid integration.
 */
...
/**
 * Get Droid thinking configuration for extended thinking.
 * For direct use when manually configuring Droid API calls.
 */
export { getDroidThinkingConfig };
