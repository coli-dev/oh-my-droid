...
// Switcher functions
getHighVariant, isAlreadyHighVariant, getThinkingConfig, getDroidThinkingConfig, THINKING_CONFIGS, 
// State management
...
World`);
    ...
    describe('switcher - getThinkingConfig', () => {
        describe('Anthropic provider', () => {
            it('should return config for Droid models', () => {
        ...
        describe('Amazon Bedrock provider', () => {
            it('should return config for Droid models on Bedrock', () => {
        ...
        describe('GitHub Copilot proxy', () => {
            it('should resolve to anthropic for Droid model', () => {
    ...
    describe('switcher - getDroidThinkingConfig', () => {
        it('should return default config with 64000 tokens', () => {
            const config = getDroidThinkingConfig();
        ...
        it('should accept custom budget tokens', () => {
            const config = getDroidThinkingConfig(32000);
