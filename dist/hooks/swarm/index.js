...
import { initDb, closeDb, deleteDb, isDbInitialized, initSession, loadState, saveState, addTasks, getTasks, getTasksByStatus, getTasksByWave, getTask, getStats, getHeartbeats, clearAllData, writeSwarmSummary, getNextTaskId } from './state.js';
import { claimTask as claimTaskInternal, releaseTask as releaseTaskInternal, completeTask as completeTaskInternal, failTask as failTaskInternal, heartbeat as heartbeatInternal, cleanupStaleClaims as cleanupStaleClaimsInternal, getTasksClaimedBy, hasPendingTasks, allTasksComplete, getActiveAgentCount, reclaimFailedTask, setSwarmCwd, claimTaskForFiles as claimTaskForFilesInternal } from './claiming.js';
 ...
 */
export function addMoreTasks(tasks) {
    if (!isDbInitialized()) {
 ...
 */
export function getTasksForWave(wave) {
