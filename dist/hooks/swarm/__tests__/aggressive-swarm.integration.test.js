...
import { startSwarm, stopSwarm, claimTask, completeTask, failTask, addMoreTasks, getAvailableSlots, getSwarmStats, getAllTasks, hasPendingWork, isSwarmComplete } from '../index.js';
describe('Aggressive Swarm Integration', () => {
    ...
    it('should handle 25 tasks with wave-based processing', async () => {
        ...
        const taskDescriptions = Array.from({ length: 25 }, (_, i) => `Fix TypeScript errors in file-${i + 1}.ts`);
...
//# sourceMappingURL=aggressive-swarm.integration.test.js.map