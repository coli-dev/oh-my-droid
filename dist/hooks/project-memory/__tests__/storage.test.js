...
describe('Project Memory Storage', () => {
    ...
    describe('getMemoryPath', () => {
        it('should return correct memory file path', () => {
            ...
            expect(memoryPath).toBe(path.join(projectRoot, '.omd', 'project-memory.json'));
        });
    });
    describe('saveProjectMemory', () => {
        it('should create .omd directory and save memory file', async () => {
            ...
            // Verify .omd directory exists
            const omdDir = path.join(projectRoot, '.omd');
            const omdStat = await fs.stat(omdDir);
            expect(omdStat.isDirectory()).toBe(true);
    ...
    describe('loadProjectMemory', () => {
        ...
        it('should return null for invalid JSON', async () => {
            // Create .omd directory
            const omdDir = path.join(projectRoot, '.omd');
            await fs.mkdir(omdDir, { recursive: true });
            // Write invalid JSON
            const memoryPath = getMemoryPath(projectRoot);
