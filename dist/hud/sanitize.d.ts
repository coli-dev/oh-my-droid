/**
 * OMD HUD - Output Sanitizer
 *
 * Sanitizes HUD output to prevent terminal rendering corruption
 * when Droid's Ink renderer is concurrently updating the display.
 *
 ...
 * with Droid's terminal cursor positioning during active rendering.
 *
