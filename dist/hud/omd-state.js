 ...
 * 1. Session-scoped paths (.omd/state/sessions/{id}/{filename}) - newest first
 * 2. Standard path (.omd/state/{filename})
 * 3. Legacy path (.omd/{filename})
 *
...
//# sourceMappingURL=omd-state.js.map