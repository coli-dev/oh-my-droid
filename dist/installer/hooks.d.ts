/**
 * Hook Scripts for Droid
 * Hook system inspired by oh-my-opencode, adapted for Droid's native hooks
 *
 * Droid hooks are configured in settings.json and run as shell commands.
...
export declare function getDroidConfigDir(): string;
