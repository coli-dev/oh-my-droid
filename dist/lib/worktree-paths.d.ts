...
export declare const OmdPaths: {
    ...
    readonly PLANS: ".omd/plans";
    readonly RESEARCH: ".omd/research";
    readonly NOTEPAD: ".omd/notepad.md";
    readonly PROJECT_MEMORY: ".omd/project-memory.json";
    readonly DRAFTS: ".omd/drafts";
    readonly NOTEPADS: ".omd/notepads";
    readonly LOGS: ".omd/logs";
    readonly SCIENTIST: ".omd/scientist";
    readonly AUTOPILOT: ".omd/autopilot";
    readonly SKILLS: ".omd/skills";
};
/**
...
/**
 * Resolve a relative path under .omd/ to an absolute path.
 * Validates the path is within the worktree boundary.
 *
 * @param relativePath - Path relative to .omd/ (e.g., "state/ralph.json")
 ...
 *
 * @param relativePath - Path relative to .omd/
 * @param worktreeRoot - Optional worktree root
 ...
 *
 * This prevents concurrent Droid instances in the same repo from
 ...
 * Path: .omd/state/sessions/{sessionId}/{mode}-state.json
 *
 ...
 * Path: .omd/state/sessions/{sessionId}/
 *
 * @param sessionId - Session identifier
 * @param worktreeRoot - Optional worktree root
