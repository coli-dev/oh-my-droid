...
describe("Skill Bridge Module", () => {
    ...
    beforeEach(() => {
        ...
        testProjectRoot = join(tmpdir(), `omd-bridge-test-${Date.now()}`);
    ...
    describe("findSkillFiles", () => {
        it("should discover skills in project .omd/skills/", () => {
            const skillsDir = join(testProjectRoot, ".omd", "skills");
...
Content`;
    ...
    describe("Session Cache", () => {
        ...
        it("should persist state to file", () => {
            ...
            const stateFile = join(testProjectRoot, ".omd", "state", "skill-sessions.json");
