...
describe('tmux-detector', () => {
    ...
    describe('analyzePaneContent', () => {
        it('should detect rate limit messages with Droid context', () => {
            const content = `
        Droid v1.2.3
      ...
      `;
            ...
            expect(result.hasDroidCode).toBe(true);
      ...
      `;
        ...
        it('should not flag content without Droid indicators', () => {
            const content = `
        vim test.js
        Hello World
      `;
            const result = analyzePaneContent(content);
            expect(result.hasDroidCode).toBe(false);
    ...
    describe('listTmuxPanes', () => {
        it('should parse tmux pane list correctly', () => {
            ...
            vi.mocked(execSync).mockReturnValue('main:0.0 %0 1 dev Droid\nmain:0.1 %1 0 dev Other\n');
    ...
    describe('formatBlockedPanesSummary', () => {
        it('should format empty list', () => {
            ...
            expect(result).toBe('No blocked Droid sessions detected.');
        });
