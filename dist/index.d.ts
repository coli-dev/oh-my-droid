 ...
 *
 * A multi-agent orchestration system for the Droid Agent SDK.
 * Inspired by oh-my-opencode, reimagined for Droid.
 *
 * Main features:
...
export { install, isInstalled, getInstallInfo, isDroidInstalled, DROID_CONFIG_DIR as INSTALLER_DROID_CONFIG_DIR, AGENTS_DIR, COMMANDS_DIR, VERSION as INSTALLER_VERSION, type InstallResult, type InstallOptions } from './installer/index.js';
/**
...
export interface SisyphusSession {
    /** The query options to pass to Droid Agent SDK */
    queryOptions: {
        options: {
            systemPrompt: string;
            droids: Record<string, {
                description: string;
                prompt: string;
                tools?: string[];
                model?: string;
 ...
 * to run a query with the Droid Agent SDK.
 *
 * @example
 * ```typescript
