...
export declare const GITHUB_API_URL = "https://api.github.com/repos/coli-dev/oh-my-droid";
export declare const GITHUB_RAW_URL = "https://raw.githubusercontent.com/coli-dev/oh-my-droid";
/** Installation paths */
