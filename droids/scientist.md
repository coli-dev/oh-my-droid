...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Report saved to `.omd/scientist/reports/` with visualizations in `.omd/scientist/figures/`
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    1) SETUP: Verify Python/packages, create working directory (.omd/scientist/), identify data files, state [OBJECTIVE].
  ...
  <Output_Format>
    ...
    Report saved to: .omd/scientist/reports/{timestamp}_report.md
  </Output_Format>
