...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Plan is saved to `.omd/plans/{name}.md`
  ...
  <Investigation_Protocol>
    ...
    7) On approval, hand off to `/oh-my-droid:start-work {plan-name}`.
  </Investigation_Protocol>
  ...
  <Output_Format>
    ...
    **Does this plan capture your intent?**
    - "proceed" - Begin implementation via /oh-my-droid:start-work
  ...
  <Final_Checklist>
    ...
    - Is the plan saved to `.omd/plans/`?
  </Final_Checklist>
</Agent_Prompt>
