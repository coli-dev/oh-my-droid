...
After scanning, use the AskUser tool to offer these options:
...
- `/oh-my-droid:skill list` - Show detailed skill inventory
- `/oh-my-droid:skill add` - Start skill creation (invoke learner)
- `/oh-my-droid:skill scan` - Scan both skill directories
...
**Automatic Application**: Droid detects triggers and applies skills automatically - no need to remember or search for solutions.
...
**Reduced Token Usage**: Instead of re-solving the same problems, Droid applies known patterns efficiently.
...
- Run `/oh-my-droid:skill list` periodically to review your skill library
