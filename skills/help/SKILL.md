...
**You don't need to learn any commands!** OMD enhances Droid with intelligent behaviors that activate automatically.
...
Analyze your oh-my-droid usage and get tailored recommendations to improve your workflow.

> Note: This replaces the former `/oh-my-droid:learn-about-omd` skill.
...
- **README**: https://github.com/coli-dev/oh-my-droid
- **Issues**: https://github.com/coli-dev/oh-my-droid/issues
