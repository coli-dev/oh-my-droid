...
3. **Spawns** up to 5 parallel workers (Droid limit)
...
**Settings Explained:**
- `maxWorkers` - Max parallel workers (5 is Droid limit)
...
**Planned for v4.2:**
- Multi-machine distribution (if Droid supports)
