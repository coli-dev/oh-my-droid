...
Task(subagent_type="oh-my-droid:scientist", model="haiku", prompt="[RESEARCH_STAGE:1] Investigate...")
...
Task(subagent_type="oh-my-droid:scientist", model="haiku", prompt="[STAGE:1] Analyze src/api/...")
Task(subagent_type="oh-my-droid:scientist", model="haiku", prompt="[STAGE:2] Analyze src/utils/...")
Task(subagent_type="oh-my-droid:scientist", model="haiku", prompt="[STAGE:3] Analyze src/components/...")
```
