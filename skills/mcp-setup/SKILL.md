...
MCP servers provide additional tools that Droid droids can use. This skill helps you configure popular MCP servers using the `droid mcp add` command-line interface.
