...
Reusable skills are not code snippets to copy-paste, but **principles and decision-making heuristics** that teach Droid HOW TO THINK about a class of problems.
...
A good skill changes how Droid APPROACHES problems, not just what code it produces.
...
- **User-level**: ~/.droid/skills/omd-learned/ - Rare. Only for truly portable insights.
...
## The Approach
The decision-making heuristic, not just code. How should Droid THINK about this?
...
**Key**: A skill is REUSABLE if Droid can apply it to NEW situations, not just identical ones.
