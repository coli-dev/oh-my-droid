...
- "This plan is saved to `.omd/plans/auth-system.md`"
...
──────────
1. Review this plan
2. Modify if needed: edit .omd/plans/auth-system.md
...
```
/oh-my-droid:review auth-system
```
...
A: Absolutely! Plans are saved as markdown in `.omd/plans/`. Edit the file, then execute it.
