...
This directory contains demo scripts for showcasing Oh-My-DroidCode's capabilities.
...
- **State cleanup**: Between demos, verify clean state with `/oh-my-droid:cancel`
