...
---
# oh-my-droid: Multi-Agent Orchestration for Droid
...
Note: This is a 60-minute seminar covering the complete oh-my-droid system. We'll focus on practical usage patterns.
...
Note: These are real problems I faced building production applications with Droid. OMD was born from frustration with manually orchestrating AI-assisted development.
...
**A multi-agent orchestration system for Droid**
...
```
User -> Droid -> [Does everything itself]
```

**OMD Workflow:**
```
User -> Droid (Conductor) -> [Delegates to specialists]
                                    |
                    +---------------+---------------+
                    |               |               |
...
**Droid becomes an intelligent orchestrator** that delegates to the right specialist for each task.

Note: This is the core mental model. Droid stops being a generalist trying to do everything and becomes a smart coordinator.
...
/oh-my-droid:autopilot Add OAuth2 authentication
...
Note: The model parameter is always passed explicitly - Droid doesn't auto-apply model from agent definitions.
...
Plan saved to: .omd/plans/auth-system.md
```
...
**Real-time visibility into OMD state:**
...
Note: The HUD integrates with Droid's statusLine API to show real-time orchestration state.
...
```bash
git clone https://github.com/coli-dev/oh-my-droid.git
cd oh-my-droid
...
**GitHub Repository**
```
github.com/coli-dev/oh-my-droid
```

**Website & Documentation**
```
yeachan-heo.github.io/oh-my-droid-website
```
...
| Question | Answer |
|----------|--------|
| Does OMD work with Droid API keys? | Yes, both Max/Pro subscription and API keys work |
...
| omd-setup | Setup wizard | `/omd-setup` |
...
|----------|--------------|--------|
| `autopilot:` | `/oh-my-droid:autopilot` | Full autonomous mode |
| `ralph:` | `/oh-my-droid:ralph` | Persistence mode |
| `ulw` | `/oh-my-droid:ultrawork` | Parallel execution |
| `eco:` | `/oh-my-droid:ecomode` | Token-efficient mode |
| `plan` | `/oh-my-droid:plan` | Planning interview |
