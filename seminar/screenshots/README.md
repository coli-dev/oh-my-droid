...
│                                                                             │
│   📄 Output: .omd/autopilot/spec.md (428 lines)                            │
│                                                                             │
│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │
...
│   ✓ Risk assessment: LOW                                                   │
│                                                                             │
│   📄 Output: .omd/plans/autopilot-impl.md (23 tasks)                       │
│                                                                             │
│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │
...
**Description:** Split-screen comparison showing manual Droid usage on left vs. OMD orchestrated on right, demonstrating the difference in workflow.
...
```
┌─────────────────────────────────────┬─────────────────────────────────────┐
│ BEFORE: Manual Droid          │ AFTER: OMD Orchestration            │
├─────────────────────────────────────┼─────────────────────────────────────┤
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ 🎯 OMD HUD │ Agents: 3 active │ Todos: 8/15 done │ Tokens: 145K/200K │ 🟢   │
...
1. Use a pipeline preset or custom pipeline:
   ```
   /oh-my-droid:pipeline review "analyze the authentication system"
   ```
2. Capture showing each stage completing and passing data to next
3. Alternative: Check `.omd/logs/pipeline.log` for formatted output
