 ...
 * Basic Usage Example
 *
 * This example demonstrates how to use Oh-My-Droid-Sisyphus
 * with the Droid Agent SDK.
 */
...
async function main() {
  console.log('=== Oh-My-Droid-Sisyphus Example ===\n');
  ...
  // Example 4: Using with Droid Agent SDK (pseudo-code)
  console.log('Example 4: Using with Droid Agent SDK');
  console.log(`
// Real usage with Droid Agent SDK:
import { query } from '@anthropic-ai/claude-agent-sdk';
