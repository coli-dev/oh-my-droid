...
- Survives conversation compaction (per AGENTS.md)
...
### Comparison
| Aspect | Hephaestus (OMO) | Deep-Executor (OMD) |
|--------|------------------|---------------------|
...
| **Framework scope** | Part of OpenCode ecosystem | Part of Droid ecosystem |
...
- Follows existing OMD patterns (ultrawork, pipeline)
...
## Appendix A: Implementation Checklist for OMD
