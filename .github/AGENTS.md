# Droid AI Instructions for oh-my-droid

This file provides context for Droid when working on this repository via GitHub Actions.
...
### Installation
```bash
/plugin marketplace add coli-dev/oh-my-droid
```
...
- Check if user installed via correct method: `/plugin marketplace add coli-dev/oh-my-droid`
- Common issues: outdated Droid version, missing dependencies
