...
or
```
/oh-my-droid:swarm 30:executor "fix all TypeScript errors"
```
...
# Aggressive Mode
/oh-my-droid:swarm 30:executor "fix all TypeScript errors"
/oh-my-droid:swarm aggressive:build-fixer "fix build errors across entire codebase"
```
...
```
/oh-my-droid:swarm 3:executor "fix linting errors in src/api/"
```
...
```
/oh-my-droid:swarm aggressive:executor "add unit tests for all untested functions"
```
...
### Security Audit
```
/oh-my-droid:swarm aggressive:security-reviewer "audit codebase for SQL injection vulnerabilities"
```
