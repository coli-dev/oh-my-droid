...
export interface PaneAnalysisResult {
  /** Whether this pane appears to have Droid */
  hasDroidCode: boolean;
...
export interface DaemonConfig {
  ...
  verbose?: boolean;
  /** State file path (default: ~/.omd/state/rate-limit-daemon.json) */
  stateFilePath?: string;
  /** PID file path (default: ~/.omd/state/rate-limit-daemon.pid) */
  pidFilePath?: string;
  /** Log file path (default: ~/.omd/state/rate-limit-daemon.log) */
  logFilePath?: string;
}
