...
function selectAgentType(component: Component): string {
  const roleToAgent: Record<ComponentRole, string> = {
    frontend: 'oh-my-droid:designer',
    backend: 'oh-my-droid:executor',
    database: 'oh-my-droid:executor',
    ...
    module: 'oh-my-droid:executor'
  };

  return roleToAgent[component.role] || 'oh-my-droid:executor';
}
