  ...
  describe("AGENT_DEFINITIONS", () => {
    ...
    it("should have consistent model assignments", () => {
      const modelExpectations: Record<string, string> = {
        "architect.md": "custom:claude-opus-4.5-6",
        "executor.md": "custom:gpt-5.3-codex-3",
        "designer.md": "custom:gemini-3-pro-8",
        "writer.md": "custom:claude-haiku-4.5-4",
        "vision.md": "custom:gemini-3-pro-8",
        "critic.md": "custom:gpt-5.3-codex-3",
        "analyst.md": "custom:gpt-5.3-codex-3",
        "planner.md": "custom:claude-opus-4.5-6",
        "qa-tester.md": "custom:gpt-5.2-1",
        "debugger.md": "custom:gpt-5.2-1",
        "verifier.md": "custom:claude-sonnet-4.5-5",
        "style-reviewer.md": "custom:gemini-3-flash-7",
        "quality-reviewer.md": "custom:gpt-5.3-codex-3",
        "api-reviewer.md": "custom:claude-sonnet-4.5-5",
        "performance-reviewer.md": "custom:claude-sonnet-4.5-5",
        "test-engineer.md": "custom:gpt-5.2-codex-2",
        "security-reviewer.md": "custom:gpt-5.3-codex-3",
        "build-fixer.md": "custom:gpt-5.2-codex-2",
        "git-master.md": "custom:claude-sonnet-4.5-5",
        "deep-executor.md": "custom:gpt-5.3-codex-3",
      };
