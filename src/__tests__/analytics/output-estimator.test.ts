...
describe('OutputEstimator', () => {
  describe('estimateOutputTokens', () => {
    ...
    it('should use default ratio for unknown models', () => {
      const estimate = estimateOutputTokens(1000, 'droid-unknown-model');
    ...
    it('should be case-insensitive for model names', () => {
      expect(estimateOutputTokens(1000, 'DROID-HAIKU-4-5-20251001')).toBe(300);
      expect(estimateOutputTokens(1000, 'Droid-Sonnet-4-5-20250929')).toBe(400);
      expect(estimateOutputTokens(1000, 'droid-OPUS-4-6-20260205')).toBe(500);
    });
