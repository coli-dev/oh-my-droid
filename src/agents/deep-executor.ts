...
export const DEEP_EXECUTOR_PROMPT_METADATA: AgentPromptMetadata = {
  ...
  triggers: [
    {
      ...
      trigger: "Multi-file changes, unclear scope, needs exploration",
    },
    {
      domain: "Deep work",
      trigger: "Goal-oriented tasks requiring sustained focus",
    },
    {
      domain: "Forge",
      trigger: "Complex implementation needing deep reasoning",
    },
  ],
  useWhen: [
  ...
  promptDescription:
    "Deep executor for complex goal-oriented tasks. Explores extensively before acting, executes all work itself, and guarantees completion with evidence.",
};

export const deepExecutorAgent: AgentConfig = {
  name: "deep-executor",
  description:
    "Deep executor for complex goal-oriented tasks. Explores extensively, executes all work itself, guarantees 100% completion with evidence.",
