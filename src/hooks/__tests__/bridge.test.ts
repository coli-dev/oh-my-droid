...
describe('processHook - Environment Kill-Switches', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.OMD_SKIP_HOOKS;
    resetSkipHooksCache();
  });
  ...
  describe('DISABLE_OMD flag', () => {
    it('should return continue:true when DISABLE_OMD=1', async () => {
    ...
    it('should return continue:true when DISABLE_OMD=true (string)', async () => {
    ...
    it('should process normally when DISABLE_OMD is not set', async () => {
      const input: HookInput = {
        sessionId: 'test-session',
        prompt: 'hello world',
        directory: '/tmp/test'
    ...
    it('should process normally when DISABLE_OMD=false', async () => {
  ...
  describe('OMD_SKIP_HOOKS flag', () => {
    ...
    it('should skip multiple hook types when comma-separated', async () => {
      process.env.OMD_SKIP_HOOKS = 'pre-tool-use,persistent-mode';
    ...
    it('should handle whitespace in OMD_SKIP_HOOKS', async () => {
      process.env.OMD_SKIP_HOOKS = ' pre-tool-use , persistent-mode ';
    ...
    it('should process normally when hook type is not in skip list', async () => {
      process.env.OMD_SKIP_HOOKS = 'persistent-mode';
    ...
    it('should process normally when OMD_SKIP_HOOKS is empty', async () => {
      process.env.OMD_SKIP_HOOKS = '';
  ...
  describe('Combined flags', () => {
    it('should respect DISABLE_OMD even if OMD_SKIP_HOOKS is set', async () => {
      process.env.DISABLE_OMD = '1';
  ...
  describe('Performance', () => {
    ...
    it('should have minimal overhead when DISABLE_OMD=1', async () => {
      process.env.DISABLE_OMD = '1';
  ...
  describe('All hook types', () => {
    ...
    it('should disable all hook types when DISABLE_OMD=1', async () => {
      process.env.DISABLE_OMD = '1';
