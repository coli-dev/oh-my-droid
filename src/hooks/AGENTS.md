...
Hooks intercept Droid events to enable:
...
- Verify state persistence in `.omd/state/`
...
**Why soft enforcement**: Hard blocking (`continue: false`) would prevent context compaction and could deadlock Droid.
