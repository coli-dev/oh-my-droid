...
/**
 * Get the Droid storage directory
 */
function getDroidCodeStorageDir(): string {
  return join(getDataDir(), 'droid-code', 'storage');
}

export const DROID_CODE_STORAGE = getDroidCodeStorageDir();
export const MESSAGE_STORAGE = join(DROID_CODE_STORAGE, 'message');
export const PART_STORAGE = join(DROID_CODE_STORAGE, 'part');
