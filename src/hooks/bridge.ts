...
/**
 * Input format from Droid hooks (via stdin)
 */
...
/**
 * Output format for Droid hooks (to stdout)
 */
      ...
      if (runningCount >= maxBgTasks) {
        return {
          ...
          reason:
            ...
            `Limit is configurable via permissions.maxBackgroundTasks in config or OMD_MAX_BACKGROUND_TASKS env var.`,
        };
      }
    }
  }
