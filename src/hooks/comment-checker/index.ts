 ...
 *
 * Detects comments and docstrings in code changes and prompts Droid
...
/**
 * Create comment checker hook for Droid shell hooks
 *
 * This hook checks for comments in Write/Edit operations and injects
 * a message prompting Droid to justify or remove unnecessary comments.
 */
