 ...
 * Default worktree location: ~/Workspace/omd-worktrees/
 */
...
const DEFAULT_WORKTREE_ROOT = join(homedir(), 'Workspace', 'omd-worktrees');

/**
 * Parse a reference string into components
 * Supports: omd#123, owner/repo#123, #123, URLs, feature names
 */
