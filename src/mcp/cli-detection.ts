...
export function detectCodexCli(useCache = true): CliDetectionResult {
  ...
  try {
    ...
    try {
      version = execSync("codex --version", {
        encoding: "utf-8",
        timeout: 5000,
      }).trim();
    } catch {
...
export function detectGeminiCli(useCache = true): CliDetectionResult {
  ...
  const installHint =
    "Install Gemini CLI: npm install -g @google/gemini-cli (see https://github.com/google-gemini/gemini-cli)";
  ...
  try {
    ...
    let version: string | undefined;
    try {
      version = execSync("gemini --version", {
        encoding: "utf-8",
        timeout: 5000,
      }).trim();
    } catch {
